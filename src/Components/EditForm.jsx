...
function EditForm({ ppcId, phoneNumber }) {
  ...
  //   setStep("preview"); // Show preview-section
  // };
      ...
      {photos.map((photo, index) => {
        ...
        return (
          <div key={index} className="uploaded-photo-item">
            ...
            />
            <button className="" onClick={() => removePhoto(index)}>
              Remove
            </button>
          </div>
        );
  ...
  <div className="form-group" >
    ...
    <label>best Time To Call</label>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        <div className="preview-section w-100 d-flex flex-column align-items-center justify-content-center">
           <div className="mb-4">
...
<div className="d-flex flex-column justify-content-start w-100"> <button
          className=""
            type="button"
