    ...
    const fetchFavoriteProperties = async () => {
      try {
        ...
        if (response.status === 200) {
          const transformedProperties = response.data.favoriteRequestsData.flatMap(property =>
            property.favoritedUsersPhoneNumbers.map(interestedUser => ({
              ...property,
              interestedUser
            }))
          );
          ...
          // toast.error("No favorite properties found for this owner.");
        }
      } catch (error) {
