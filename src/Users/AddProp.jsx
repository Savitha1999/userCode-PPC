...
//     try {
//       const response = await axios.post('http://localhost:5000/PPC/update-property', {
//         ppcId,
//         phoneNumber,
//         ...propertyDetails,
//       });
...
//   return (
    ...
    //         placeholder="Enter property mode"
    //         required
    //       />
    //     </Form.Group>
    ...
    //       />
    //     </Form.Group>
    //     <Form.Group className="mb-3" controlId="ownerDetails">
    //       <Form.Label>Owner Details</Form.Label>
    //       <Form.Control
    //         type="text"
    //         name="ownerDetails"
    //         value={propertyDetails.ownerDetails}
    //         onChange={handleInputChange}
...
// const AddProp = () => {
//   const location = useLocation();
//   const { ppcId, phoneNumber } = location.state || {}; // Retrieve PPC-ID and phone number from location.state
//   const [propertyDetails, setPropertyDetails] = useState({
//     propertyMode: '',
//     propertyType: '',
//     ownerDetails: '',
...
//   // Handle property details input change
//   const handleInputChange = (e) => {
//     const { name, value } = e.target;
//     setPropertyDetails((prevDetails) => ({ ...prevDetails, [name]: value }));
//   };
...
//     formData.append('ownerDetails', propertyDetails.ownerDetails);

//     try {
//       const response = await axios.post('http://localhost:5000/PPC/update-property', formData, {
//         headers: {
